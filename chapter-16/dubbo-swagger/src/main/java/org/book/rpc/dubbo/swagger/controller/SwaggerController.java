...
public class SwaggerController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "nickname", value = "昵称", paramType = "path", defaultValue = "张三", dataType = "string")
    })
    @ApiResponses({
    ...
    @RequestMapping(value = "api/{age}/{nickname}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public Customer api(@PathVariable("age") int age, @PathVariable("nickname") String nickname) {
